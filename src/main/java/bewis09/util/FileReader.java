...
public class FileReader {
    ...
    public static void reloadStrings() {
        ...
        try {
            ...
            try {
                boolean bl2 = new File(FabricLoader.getInstance().getGameDir() + "\\bewisclient\\options.bof").getParentFile().mkdirs();
                boolean bl = new File(FabricLoader.getInstance().getGameDir() + "\\bewisclient\\options.bof").createNewFile();
                if(!bl||!bl2) {
