...
public class CosmeticsScreen extends Screen {
    ...
    protected CosmeticsScreen(Screen parent) {
        super(Text.empty());
        this.parent = parent;
    }
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.fill(13, height/2-70,83, height/2+70,0xFF000000);
        context.drawBorder(13, height/2-70,70,140,-1);
        drawEntity(context,48, height/2+50,50,(isReversed?1:-1)*(mouseX-48), height / 2f - mouseY,client.player, isReversed);
        ...
        context.drawBorder(109, (int) (getScrollY()+5),64*Capes.CAPES.length+5,120,-1);
        context.fill(109, (int) (getScrollY()+5),109+64*Capes.CAPES.length+5, (int) (getScrollY()+125),0xAA000000);
        context.drawBorder(109, (int) (getScrollY()+135),64*Wing.WINGS.length+5,120,-1);
        context.fill(109, (int) (getScrollY()+135),109+64*Wing.WINGS.length+5, (int) (getScrollY()+255),0xAA000000);
        context.drawBorder(109, (int) (getScrollY()+265),64*Hat.HATS.length+5,120,-1);
        context.fill(109, (int) (getScrollY()+265),109+64*Hat.HATS.length+5, (int) (getScrollY()+385),0xAA000000);
        Hat hat = Hat.current_hat;
        Hat.current_hat = Hat.EMPTY;
        for (AbstractCape c : Capes.CAPES) {
            z++;
            Cape.setCurrentCape(c);
            context.fill(50+z*64, (int) (getScrollY()+10),50+z*64+60, (int) (getScrollY()+110),0xFF000000);
            context.drawBorder(50+z*64, (int) (getScrollY()+10),60,100,-1);
            drawEntity(context,80+z*64, (int) (getScrollY()+90),35, (float) (mouseX - (30 + z * 64) -32), (float) (30 - mouseY+getScrollY()),client.player, true);
        }
        z=0;
        ...
        for (Wing w : Wing.WINGS) {
            z++;
            Wing.current_wing = w;
            context.fill(50+z*64, (int) (getScrollY()+140),50+z*64+60, (int) (getScrollY()+240),0xFF000000);
            context.drawBorder(50+z*64, (int) (getScrollY()+140),60,100,-1);
            drawEntity(context,80+z*64, (int) (getScrollY()+220),35, (float) (mouseX - (30 + z * 64) -32), (float) (160 - mouseY+getScrollY()),client.player, true);
        }
        Wing.current_wing = Wing.EMPTY;
        z=0;
        for (Hat w : Hat.HATS) {
            z++;
            Hat.current_hat = w;
            context.fill(50+z*64, (int) (getScrollY()+270),50+z*64+60, (int) (getScrollY()+370),0xFF000000);
            context.drawBorder(50+z*64, (int) (getScrollY()+270),60,100,-1);
            drawEntityForMoved(context,80+z*64, (int) (getScrollY()+350),35, (float) (mouseX - (30 + z * 64) -32), (float) (290 - mouseY+getScrollY()),client.player, false);
        }
        if(bl)
    ...
    public void drawEntity(DrawContext context, int x, int y, int size, float mouseX, float mouseY, LivingEntity entity, boolean isReversed) {
    ...
    public void drawEntityForMoved(DrawContext context, int x, int y, int size, float mouseX, float mouseY, LivingEntity entity, boolean isReversed) {
