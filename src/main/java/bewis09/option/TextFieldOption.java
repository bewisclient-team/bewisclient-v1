...
public class TextFieldOption extends TextOption {
    ...
    public TextFieldOption(Text text, String name, String defaultV) {
        ...
        this.name = name;
        try {
            widgets = List.of(new OptionTextFieldWidget(0, 0, 100, 20, FileReader.getByFirst("Text", name)[0], 88, 2, this::onChange));
        } catch (Exception exception) {
            widgets = List.of(new OptionTextFieldWidget(0, 0, 100, 20, defaultV, 88, 2, this::onChange));
        }
    }
